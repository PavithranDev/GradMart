...
export function DashboardSidebar() {
  ...
  return (
    <aside className="w-full lg:w-64 flex-shrink-0 lg:border-r border-black/5 bg-white lg:min-h-screen px-4 py-8 lg:px-6 lg:py-12 flex flex-col justify-between">
      <div>
